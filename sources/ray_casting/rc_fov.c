...
/*   Updated: 2025/03/05 13:55:41 by grial            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//
//	// Dibujar cada píxel de la pared en la pantalla hola alla 
//	a = 0;
//	while (a < wall_height)
//	{
//		texY = (a * texture->height) / wall_height;
//		color = *(int *)(texture->addr + (texY * texture->size_line + texX * (texture->bpp / 8)));
